			...
			<div class="fon">								
				<div class="found_form parentbox">	
					<form method="POST" >
						...
						<div class="info">
							<h2>Удалить рейс из расписание</h2>
							<h3>На этой странице вы можете:</h3>
							<ul>					
								<li>Удалить рейсы из расписания в определенный период</li>
...
_END;
									...
									<div class="inline_block width_12">
										<input type="submit" class="button" name="delete_flights" value="Удалить" id="change_id" $disabled_1>							
									</div>										
	    						...
	    						for ($i=0; $i < $num; $i++) 
	    						{
									...
									$price_business = $row['price_business'];    
										echo <<<_END
	      								<tr>	      							
											<td rowspan="2">										
												<input type="checkbox" class="example_check2" name="flight_number[]" value="$flight_number[$i]">   				
											</td>			
...
_END;
	      							...
	      							echo<<<_END
	      								...
	      								<div class="">
											<input type="submit" class="button" name="delete_flights" value="Удалить">							
										</div>	
	      							</form>
	      							</div>
_END;
