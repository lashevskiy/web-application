				...
				<div class="found_form parentbox">	
					<form method="POST">		
						...
						<div class="inline_block owerflow_hide">
							<h3>Город вылета</h3>
							<input type="text" class="input width_1 " name="flight_from" list="flight_from" id="flight_from_id" placeholder="Откуда?"  value = "$flight_from" autocomplete="off" onkeypress='showResult(this)'>	
						...
						<div class="inline_block owerflow_hide">
							...
							<input type="text" class="input width_1 " name="flight_to" list="flight_to" id="flight_to_id" placeholder="Куда?"  value = "$flight_to" autocomplete="off" onkeypress='showResult(this)'>												
							<datalist id='flight_to'></datalist>
						</div>										
						<div class="clear_both"></div>			
						<div class="">
							<input type="submit" class="button" name="chande_old" value="Найти">							
						</div>	
...
_END;
					...
					{	
						...
						{	
	    					...
	    					{
    							echo '
    								<div class="found_form center">Попробуйте выбрать другой маршрут.</div>
    							';	    						
	    					}
	    					else
	    					{
								...
								$price_business = $row['price_business'];    
									echo <<<_END
	      							<tr>	      							
										...
										<td rowspan="1">										
											<button type="submit" value="$flight_number" name="change" class="button_online_height button_online">Изменить</button>					
										</td>	
									</tr>	
									<tr>
										<td>$flight_to</td>
										<td>$time_down</td>										
										<td rowspan="1">										
											<button type="submit" value="$flight_number" name="delete" class="button_online_height button_online">Удалить</button>					
										</td>			
									</tr>
_END;
	    					}
