...
_OUT;
    	...
    	{      
    		...
    		$query = "UPDATE customers, users SET customers.first_name = '$first_name', 
...
echo<<<_OUT
					<form method="POST" action="change_information.php">						
						<h3>Личные данные</h3>	
						<div>
							<input type="text" class="input width_2" name="firstname" value="$first_name" placeholder="Имя" required>							
						</div>
						<div>
							<input type="text" class="input width_2" name="lastname" value="$last_name" placeholder="Фамилия" required>							
						</div>
						<div>
							<div>
